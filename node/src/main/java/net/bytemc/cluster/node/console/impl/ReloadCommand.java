...
public final class ReloadCommand {
    ...
    public void handle(CommandSender commandSender) {
        ...
        ((CloudServiceProviderImpl) Node.getInstance().getServiceProvider()).getQueue().checkQueue();
        ...
        Logger.info("The reload was &asuccessful&8! &7Took " + (System.currentTimeMillis() - time) + "ms");
    }
}
